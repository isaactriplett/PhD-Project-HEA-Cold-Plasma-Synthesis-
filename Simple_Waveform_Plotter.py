...
df = pd.read_csv(r"C:\Users\isaac\OneDrive\Documents\McGill\McGill Experiments\waveforms\March 2026\3_23\ionic liquid metal salt dbd\10kHz\10kHz\10kHz_15.csv", skiprows=1)
...
ax2 = ax1.twinx()
ax2.plot(df['Time (ms)'], df['Current (A)'], color='red', label='Current')
