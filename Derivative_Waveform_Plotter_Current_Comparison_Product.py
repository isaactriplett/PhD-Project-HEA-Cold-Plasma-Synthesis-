# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 00:56:47 2026
...
deriv = np.gradient(current, time)
...
plt.xlabel('Time (s)')
plt.ylabel('product of di/dt and voltage (W/s)')
plt.title('Product of Voltage and First Derivative of Current')
plt.grid(True)
